      ...
      <nav className="bg-white shadow-sm py-2 px-6 sticky top-0 z-40 border-b border-gray-100">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link to="/" className="flex items-center">
            ...
            <span className="text-xl sm:text-xl md:text-xl lg:text-xl xl:text-2xl font-semibold tracking-tight">
  Primenova Consulting
</span>
          </Link>
          ...
          {user ? (
            ...
            <Link to="/manual-login">
              <button className="flex items-center space-x-2 bg-gradient-to-r from-cyan-500 via-sky-700 to-blue-950 text-white px-5 py-2.5 rounded-full hover:bg-indigo-700 transition-colors shadow-sm hover:shadow-md cursor-pointer">
                <AiOutlineLogin />
